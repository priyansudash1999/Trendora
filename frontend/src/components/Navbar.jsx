...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      <Link to="/"> <img src= {assets.loggo} alt="" className='w-48'/> </Link>
      ...
      <div className='flex items-center gap-6'>
        <img src= {assets.search_icon} onClick={() => setShowSearch(true)} alt="" className='w-5 cursor-pointer'/>
        ...
        <Link to='/cart' className='relative'>
          ...
          <p className='absolute right-[-5px] bottom-[-5px] text-center bg-black leading-4 rounded-full aspect-square text-[8px] w-4 text-white'>{getCartCount()}</p>
        </Link>
